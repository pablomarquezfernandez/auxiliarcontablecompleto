...
public class GastoDefecto {
	...
	public GastoDefecto(long id, String nombre, String codigo) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.codigo = codigo;
	...
	public static JSONArray toJSONArray( List<GastoDefecto> categoriasContablesProductos ) throws Exception{
