...
public class PeriodoSeguridadSocial extends ElementoContabilizable{
	...
	public PeriodoSeguridadSocial(long id, String codigoEmpresa, long idTrabajador, long idContrato, long idPeriodo,
	...
	public int getTipoElemento() {
		return ElementoContabilizable.TIPO_PERIODO_SEGURIDAD_SOCIAL;
	}
	@Override
